...
directRun.addParameter(default)
directRun.addExpected("history.csv")
directRun.addExpected("restart_flow.dat")
...
adjointRun.addParameter(default)
...
dotProductDragRun.addParameter(default)
...
adjointRunCons.addParameter(default)
...
dotProductLiftRun.addParameter(default)
